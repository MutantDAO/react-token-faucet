	...
	return (
		<div style={{maxWidth:'600px'}}>
			...
			<Card style={{background: "rgb(209, 213, 219)", padding: '30px'}}>
				<Card.Body>
					<Card.Title style={{fontWeight: 600,fontSize:'1.5em'}}>Make it rain <b>({network} Testnet)</b> $FISH</Card.Title>
					<Card.Subtitle style={{margin: "30px 0px", lineHeight: 1.5}}>Click below to receive your <b>$FISH</b> for development on <b>{network} Testnet</b>.</Card.Subtitle>
